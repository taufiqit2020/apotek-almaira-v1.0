        ...
        <div class="overflow-x-auto">
            <table class="data-table w-full">
                ...
                <tbody>
                    ...
                    <tr x-data="{ active: {{ $user->is_active ? 'true' : 'false' }} }">
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    @if($user->id === auth()->id())
                                    <span class="badge bg-blue-50 text-blue-700 text-[10px] font-bold border border-blue-200">Anda</span>
                                    @endif
                                </div>
                            </div>
                        </td>
                        <td class="text-gray-600 font-mono text-sm">{{ $user->username ?? '-' }}</td>

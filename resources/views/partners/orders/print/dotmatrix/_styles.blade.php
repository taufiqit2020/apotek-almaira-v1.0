...
<style>
    @page {
        size: 250mm 285mm;
        margin: 6mm 10mm 6mm 4mm; /* Geser 0,2 cm ke kanan */
    }
    ...
    * {
    ...
    .container {
        ...
        text-align: left;
        margin: 0;
        padding: 0 0 0 2mm; /* Geser seluruh template ke kanan 0,2 cm */
        display: flex;
    ...
    @media print {
        ...
        .container { width: 100%; text-align: left; align-items: flex-start; margin: 0; padding: 0 0 0 2mm; }

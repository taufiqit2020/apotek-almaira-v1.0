...
Route::middleware(['auth', 'session.timeout'])->group(function () {
    ...
    // Categories (ajax-friendly; form create/edit via modal di index)
    ...
    // POS & Sales History & Notifications & Profile
    ...
    // User Management & Backup — IT Admin only
